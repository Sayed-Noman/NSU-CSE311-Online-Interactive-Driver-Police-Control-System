<?php
 ...
 session_start();//session start
  //IF Admin has already loged in then he will be redirected to dashboard
  ...
  if(isset($_POST['Personal_Information'])){
    ...
    $driverTablequery="UPDATE `driver` SET `Address`='$Address',`Nationality`='$Nationality' WHERE `Driver_Email_FK`='$Searched_Email'";
    $dbConnect->query($query);
    $dbConnect->query($driverTablequery);
    $dbConnect->commit();
    header('location:admin_edit_driver.php');
  }
  ...
  if(isset($_POST['Driver_Information'])){
    ...
    $query="UPDATE `account` SET `Driving_License_No`='$Driving_License_No' WHERE `Email`='$Searched_Email'";
    $driverTablequery="UPDATE `driver` SET `License_Type`='$License_Type',`License_Expire_Date`='$License_Expire_Date',`License_Issue_Date`='$License_Issue_Date' WHERE `Driver_Email_FK`='$Searched_Email'";
    $dbConnect->query($query);
    $dbConnect->query($driverTablequery);
    $dbConnect->commit();
  ...
  if(isset($_POST['Upload_Profile_Picture'])){
    //path to store the profile picture to profilepicture server
      $targetPath="../driver/driver_img/driver_profile_picture_server/".basename($_FILES['Profile_Picture']['name']);
      $Searched_Email=$_POST['Hidden_Email'];
      $Profile_Picture=$_FILES['Profile_Picture']['name'];
      $dbConnect->autocommit(false);
      $query="UPDATE `driver` SET `Driver_Profile_Picture`='$Profile_Picture' WHERE `Driver_Email_FK`='$Searched_Email'";
      $dbConnect->query($query);
      $dbConnect->commit();
    ...
    if(isset($_POST['Car_Information'])){
      ...
      $query="UPDATE `car` SET `No_Plate`='$No_Plate',`Car_Model`='$Car_Model',`Brand_Name`='$Brand_Name',`Color`='$Color',`Vechile_Type`='$Vechile_Type' WHERE `Driver_Email_Fk`='$Searched_Email'";
      $dbConnect->query($query);
      $dbConnect->commit();
  ...
  if(isset($_POST['Upload_Car_Image'])){
    //path to store the profile picture to profilepicture server
      $targetPath="../driver/driver_img/driver_car_picture_server/".basename($_FILES['Car_Picture']['name']);
      $Searched_Email=$_POST['Hidden_Email'];
      $Car_Picture=$_FILES['Car_Picture']['name'];
      $dbConnect->autocommit(false);
      $query="UPDATE `car` SET `Car_Image`='$Car_Picture' WHERE `Driver_Email_FK`='$Searched_Email'";
      $dbConnect->query($query);
      $dbConnect->commit();
      //move uploaded profile picture to the server
  ...
  if(isset($_POST['Upload_Car_Document_Image'])){
    //path to store the profile picture to profilepicture server
      $Searched_Email=$_POST['Hidden_Email'];
      $targetPath="../driver/driver_img/driver_car_document_picture_server/".basename($_FILES['Car_Document_Picture']['name']);
      $Car_Document_Picture=$_FILES['Car_Document_Picture']['name'];
      $dbConnect->autocommit(false);
      $query="UPDATE `car` SET `Car_Document_Image`='$Car_Document_Picture' WHERE `Driver_Email_FK`='$Searched_Email'";
      $dbConnect->query($query);
      $dbConnect->commit();
      //move uploaded profile picture to the server
  ...
  if(isset($_POST['Upload_Driving_License_Image'])){
      $Searched_Email=$_POST['Hidden_Email'];
      $Driving_License_Image=addslashes(file_get_contents($_FILES['Driving_License_Image']['tmp_name']));
      $query="UPDATE `account` SET `Driving_License_Image`='$Driving_License_Image' WHERE `Email`='$Searched_Email'";
      $dbConnect->query($query);
      $dbConnect->commit();
      //header('location:admin_edit_driver.php');
...
<head>
    ...
    <link rel="stylesheet" href="admin_css/admin_edit_driver_css.css">
    ...
    <title>Admin Edit Driver Page</title>
</head>
<body>
    <div class="wrapper">
        <!------------------NavigationBar--------------------------------->
        ...
        <div class="sidebar">
            ...
            <li><a href="admin_dashboard_home.php" >
                ...
                <li><a href="admin_edit_driver.php"class="active">
            ...
            <div class="item">
                  <h2>Upload Profile Picture</h2>
                    ...
                    <center>
                          <br>
                          <?php
                            echo"<img id='profile_image_preview' src='../driver/driver_img/driver_profile_picture_server/".$rowValues['Driver_Profile_Picture']."'/>";
                        ?>
                        <br>
    ...
    <div class="item">
            ...
            <input class="login-form__input" type="hidden" name="Hidden_Email" value="<?=$rowValues['Email']?>">
              ...
              <center>
                   <!--- <img id="car_image_preview"/> -->
                    <?php
                            echo"<img id='car_image_preview' src='../driver/driver_img/driver_car_picture_server/".$rowValues['Car_Image']."'/>";
                   ?>
                    <br>
      ...
      <div class="item">
              ...
              <center>
                   ...
                   <?php
                            echo"<img id='car_document_image_preview' src='../driver/driver_img/driver_car_document_picture_server/".$rowValues['Car_Document_Image']."'/>";
                        ?>
                    <br>
