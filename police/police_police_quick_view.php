<?php
    ...
    if(isset($_GET['policeQuickView'])){
        ...
        if($userType == 'Police'){
            ...
            {   
                $No_Of_Cases_Filled=intVal($policeValues['No_Of_Cases_Filled']);
            }
...
<html lang="en">
<head>
    <title>Police Account Quick View</title>
    <meta charset="UTF-8">
    <title>CV Using HTML & CSS</title>
    <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
    <link rel="stylesheet" href="police_css/police_police_quick_view_css.css">
</head>
<body>
